      ...
      <div className={`right-panel`} >
        ...
        <div className="music">
          <div className="music-btn">
            <img alt="" src="https://img.icons8.com/ultraviolet/40/000000/musical-notes.png" />
          </div>
        ...
        <div className="element">
          <div className="block-tile" ref={scheduleRef}>Lịch trình</div>
          <Schedule />
        </div>
        ...
        <div className="element ">
          <div className="block-tile " ref={mapRef}>Địa chỉ  </div>
          <Map />
        </div>
